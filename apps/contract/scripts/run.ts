...
async function main() {
  ...
  const BuyMeACoffee = await ethers.getContractFactory('BuyMeAMatic');
  ...
  await buyMeACoffee
    .connect(tipper)
    .buyMatic('Carolina', "You're the best!", tip);
  await buyMeACoffee.connect(tipper2).buyMatic('Vitto', 'Amazing teacher', tip);
  await buyMeACoffee
    .connect(tipper3)
    .buyMatic('Kay', 'I love my Proof of Knowledge', tip);
